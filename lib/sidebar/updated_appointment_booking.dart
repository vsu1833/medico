                        ...
                        onTap: () async {
                          ...
                          if (userId.isNotEmpty) {
                            ...
                            QuerySnapshot reviewSnapshot = await FirebaseFirestore.instance
                                .collection('reviews')
                                .doc(doctors[index].doctorId)
                                .collection('subcollection') // Assuming subcollection is named
                                .get();
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DoctorScreenPage(
                                  ...
                                  reviews: reviews, doctorDescription:doctors[index].description , doctorLocation: doctors[index].address, doctorImage:'', doctorImages: [], // Pass reviews to the page
                                ),
                              ),
                            );
                          } else {
